...
# From https://people.sc.fsu.edu/~jburkardt/py_src/cordic/cordic.py
...
#  Input:
#
#    real ALPHA, the angle to be shifted.
#
#    real BETA, defines the lower endpoint of
#    the angle range.
#
#  Output:
#
#    real GAMMA, the shifted angle.
#
  import numpy as np
...
#  Input:
#
#    real T, the cosine of an angle.  -1 <= T <= 1.
#
#    integer N, the number of iterations to take.
#    A value of 10 is low.  Good accuracy is achieved with 20 or more
#    iterations.
#
#  Output:
#
#    real THETA, an angle whose cosine is T.
#
#  Local:
#
#    real ANGLES(60) = arctan ( (1/2)^(0:59) )
#
  import numpy as np
  ...
  if ( 1.0 < abs ( t ) ):
    ...
    raise Exception ( 'arccos_cordic - Fatal error!' )
...
#  Input:
#
#    real T, the sine of an angle.  -1 <= T <= 1.
#
#    integer N, the number of iterations to take.
#    A value of 10 is low.  Good accuracy is achieved with 20 or more
#    iterations.
...
#  Output:
#
#    real THETA, an angle whose sine is T.
#
#  Local:
#
#    real ANGLES(60) = arctan ( (1/2)^(0:59) )
#
  ...
  if ( 1.0 < abs ( t ) ):
    ...
    print ( '  Input argument 1 < |T|.' )
    raise Exception ( 'arcsin_cordic - Fatal error!' )
...
#  Input:
#
#    real X, Y, define the tangent of an angle as Y/X.
#
#    integer N, the number of iterations to take.
#    A value of 10 is low.  Good accuracy is achieved with 20 or more
#    iterations.
...
#  Output:
#
#    real THETA, the angle whose tangent is Y/X.
#
#  Local:
#
#    real ANGLES(60) = arctan ( (1/2)^(0:59) )
...
#  Output:
#
#    real Y, the approximate cube root of X.
#
  x_mag = abs ( x )
...
#*****************************************************************************80
#
## cbrt_cordic_test() tests cbrt_cordic().
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#  Input:
#
#    integer N_DATA.  The user sets N_DATA to zero before the first call.
#
#  Output:
#
#    integer N_DATA.  On each call, the routine increments N_DATA by 1, and
...
#*****************************************************************************80
#
## cos_cordic_test() tests cossin_cordic() for the cosine.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#  Input:
#
#    real BETA, the angle (in radians).
#
#    integer N, the number of iterations to take.
#    A value of 10 is low.  Good accuracy is achieved with 20 or more
#    iterations.
...
#  Output:
#
#    real V(2), the cosine and sine of the angle.
#
#  Local:
#
#    real ANGLES(60) = arctan ( (1/2)^(0:59) )
#
#    real KPROD(33), KPROD(j) = product ( 0 <= i <= j ) K(i),
#    K(i) = 1 / sqrt ( 1 + (1/2)^(2i) ).
#
  import numpy as np
...
#
  ...
  if ( x <= 0.0 ):
    ...
    raise Exception ( 'log_cordic - Fatal error!' )
...
#*****************************************************************************80
#
## log_cordic_test() tests log_cordic().
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## sin_cordic_test() tests cossin_cordic() for the sine.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#  Input:
#
#    real X, the number whose square root is desired.
#
#    integer N, the number of iterations to take.
#    This is essentially the number of binary digits of accuracy.
#
#  Output:
#
#    real Y, the approximate square root of X.
#
  if ( x < 0.0 ):
    print ( '' )
    print ( 'sqrt_cordic - Fatal error!' )
    print ( '  X < 0.' )
    raise Exception ( 'sqrt_cordic - Fatal error!' )
